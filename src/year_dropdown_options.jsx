  ...
  renderOptions = () => {
    ...
    var options = this.state.yearsList.map((year) => (
      <div
        ...
        {selectedYear === year ? (
          <span ref={this.myRef} className="react-datepicker__year-option--selected">
            ✓
          </span>
        ) : (
          ''
    ...
    if (!maxYear || !this.state.yearsList.find((year) => year === maxYear)) {
      options.unshift(
        <div className="react-datepicker__year-option" key={'upcoming'} onClick={this.incrementYears}>
    ...
    if (!minYear || !this.state.yearsList.find((year) => year === minYear)) {
      options.push(
        <div className="react-datepicker__year-option" key={'previous'} onClick={this.decrementYears}>
